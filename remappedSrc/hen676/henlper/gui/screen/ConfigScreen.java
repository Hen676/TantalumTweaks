...
public class ConfigScreen extends Screen {
    ...
    public ConfigScreen(Screen parent) {
        super(new TranslatableTextContent("screen.henlper.config.title"));
        this.parent = parent;
    }
    ...
    static {
        OPTIONS = new Option[]{
                ...
                new DoubleOption(
                        ...
                        (gameOptions, doubleOption) -> new TranslatableTextContent("option.henlper.config.zoom_amount").append(": " + doubleOption.get(gameOptions)/10)
                ),
                ...
                CyclingOption.create(
                        "option.henlper.config.light_level_color",
                        DyeColor.values(),
                        colorOption -> new TranslatableTextContent(colorOption.getName()),
