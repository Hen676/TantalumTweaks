...
public class AutoAttackKeybinding extends TweakKeybinding {
    private static KeyBinding keyBinding;
    private static boolean toggle = false;

    public static void init() {
        keyBinding = register("key.tantalumtweaks.auto_attack", GLFW.GLFW_KEY_KP_4);
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            while (keyBinding.wasPressed()) {
                ...
                MutableText text = Text.translatable("message.tantalumtweaks.auto_attack")
