...
import hen676.tantalumtweaks.keybinds.DebugKeybinding;
import hen676.tantalumtweaks.keybinds.LightLevelKeybinding;
...
public class LightLevelRenderer {
    ...
    public static void render(WorldRenderContext worldRenderContext) {
        ...
        if (lastWasFrameDebug && frames != 0) {
            TantalumTweaks.LOGGER.info("Average time for light level function during debug was: {}", time / frames);
            time = 0;
            frames = 0;
