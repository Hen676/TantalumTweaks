package hen676.tantalumtweaks.config;
...
public class ConfigLoader {
    ...
    private static final File file = new File(FabricLoader.getInstance().getConfigDir().resolve(TantalumTweaks.MOD_ID + ".properties").toString());
    ...
    private static void catchMethod(Exception e, String error) {
        TantalumTweaks.LOGGER.error(error);
        TantalumTweaks.LOGGER.trace(e);
        toggle = true;
    }
