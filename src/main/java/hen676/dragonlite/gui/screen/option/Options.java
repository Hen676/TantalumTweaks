...
public class Options {
    ...
    public static final SimpleOption<Double> compassAlpha = new SimpleOption<>("option.dragonlite.config.compass_alpha",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.compass_alpha"), (int)(value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(10, 100)).withModifier(
    ...
    public static final SimpleOption<Integer> compassXOffset = new SimpleOption<>("option.dragonlite.config.compass_x_offset",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.pixel_value", Text.translatable("option.dragonlite.config.compass_x_offset"), value),
            new SimpleOption.ValidatingIntSliderCallbacks(0, 30),
            Codec.intRange(0, 30),
            4,
            value -> Config.COMPASS_X_OFFSET = value);
    public static final SimpleOption<Integer> compassYOffset = new SimpleOption<>("option.dragonlite.config.compass_y_offset",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.pixel_value", Text.translatable("option.dragonlite.config.compass_y_offset"), value),
            new SimpleOption.ValidatingIntSliderCallbacks(0, 30),
            Codec.intRange(0, 30),
            4,
            value -> Config.COMPASS_Y_OFFSET = value);
    public static final SimpleOption<Integer> compassGap = new SimpleOption<>("option.dragonlite.config.compass_gap",
            SimpleOption.constantTooltip(Text.translatable("option.dragonlite.config.compass_gap.tooltip")),
            (optionText, value) -> Text.translatable("options.pixel_value", Text.translatable("option.dragonlite.config.compass_gap"), value),
    ...
    // Compass colors
    public static final SimpleOption<Double> compassColorRedX = new SimpleOption<>("option.dragonlite.config.red",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.red"), (int) (value * 100.0D)),
    ...
    public static final SimpleOption<Double> compassColorGreenX = new SimpleOption<>("option.dragonlite.config.green",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.green"), (int) (value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(0, 100)).withModifier(
                    (sliderProgressValue) -> (double) sliderProgressValue / 100.0D,
                    (value) -> (int) (value * 100.0D)),
            Codec.doubleRange(0.0D, 1.0D), 0.4D,
            value -> Config.COMPASS_X_COLOR_GREEN = value);
    public static final SimpleOption<Double> compassColorBlueX = new SimpleOption<>("option.dragonlite.config.blue",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.blue"), (int) (value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(0, 100)).withModifier(
                    (sliderProgressValue) -> (double) sliderProgressValue / 100.0D,
                    (value) -> (int) (value * 100.0D)),
            Codec.doubleRange(0.0D, 1.0D), 0.4D,
            value -> Config.COMPASS_X_COLOR_BLUE = value);
    public static final SimpleOption<Double> compassColorRedY = new SimpleOption<>("option.dragonlite.config.red",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.red"), (int) (value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(0, 100)).withModifier(
                    (sliderProgressValue) -> (double) sliderProgressValue / 100.0D,
    ...
    public static final SimpleOption<Double> compassColorGreenY = new SimpleOption<>("option.dragonlite.config.green",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.green"), (int) (value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(0, 100)).withModifier(
                    (sliderProgressValue) -> (double) sliderProgressValue / 100.0D,
    ...
    public static final SimpleOption<Double> compassColorBlueY = new SimpleOption<>("option.dragonlite.config.blue",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.blue"), (int) (value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(0, 100)).withModifier(
                    (sliderProgressValue) -> (double) sliderProgressValue / 100.0D,
    ...
    public static final SimpleOption<Double> compassColorRedZ = new SimpleOption<>("option.dragonlite.config.red",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.red"), (int) (value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(0, 100)).withModifier(
                    (sliderProgressValue) -> (double) sliderProgressValue / 100.0D,
    ...
    public static final SimpleOption<Double> compassColorGreenZ = new SimpleOption<>("option.dragonlite.config.green",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.green"), (int) (value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(0, 100)).withModifier(
                    (sliderProgressValue) -> (double) sliderProgressValue / 100.0D,
    ...
    public static final SimpleOption<Double> compassColorBlueZ = new SimpleOption<>("option.dragonlite.config.blue",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.blue"), (int) (value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(0, 100)).withModifier(
                    (sliderProgressValue) -> (double) sliderProgressValue / 100.0D,
    ...
    public static final SimpleOption<Double> compassColorRedRotation = new SimpleOption<>("option.dragonlite.config.red",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.red"), (int) (value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(0, 100)).withModifier(
                    (sliderProgressValue) -> (double) sliderProgressValue / 100.0D,
    ...
    public static final SimpleOption<Double> compassColorGreenRotation = new SimpleOption<>("option.dragonlite.config.green",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.green"), (int) (value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(0, 100)).withModifier(
                    (sliderProgressValue) -> (double) sliderProgressValue / 100.0D,
    ...
    public static final SimpleOption<Double> compassColorBlueRotation = new SimpleOption<>("option.dragonlite.config.blue",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.blue"), (int) (value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(0, 100)).withModifier(
                    (sliderProgressValue) -> (double) sliderProgressValue / 100.0D,
    ...
    // Light level options
    public static final SimpleOption<Double> lightLevelColorRed = new SimpleOption<>("option.dragonlite.config.red",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.red"), (int) (value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(0, 100)).withModifier(
                    (sliderProgressValue) -> (double) sliderProgressValue / 100.0D,
    ...
    public static final SimpleOption<Double> lightLevelColorGreen = new SimpleOption<>("option.dragonlite.config.green",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.green"), (int) (value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(0, 100)).withModifier(
                    (sliderProgressValue) -> (double) sliderProgressValue / 100.0D,
    ...
    public static final SimpleOption<Double> lightLevelColorBlue = new SimpleOption<>("option.dragonlite.config.blue",
            SimpleOption.emptyTooltip(),
            (optionText, value) -> Text.translatable("options.percent_value", Text.translatable("option.dragonlite.config.blue"), (int) (value * 100.0D)),
            (new SimpleOption.ValidatingIntSliderCallbacks(0, 100)).withModifier(
                    (sliderProgressValue) -> (double) sliderProgressValue / 100.0D,
    ...
    public static final SimpleOption<Boolean> effectTooltip = SimpleOption.ofBoolean("option.dragonlite.config.effect_tooltip",
            true,
